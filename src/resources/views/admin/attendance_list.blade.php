...
<div class="attendance-list_screen">
    ...
    <div class="previous-month">
        <a href="{{ route('admin.attendance.list', ['year' => $month == 1 ? $year - 1 : $year, 'month' => $month == 1 ? 12 : $month - 1]) }}">
    ...
    <div class="calendar">
        <div class="calendar_image">
            <a href="{{ route('admin.attendance.list', ['year' => $year, 'month' => $month]) }}">
    ...
    <div class="later-month">
        <a href="{{ route('admin.attendance.list', ['year' => $month == 12 ? $year + 1 : $year, 'month' => $month == 12 ? 1 : $month + 1]) }}">
